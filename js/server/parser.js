...
(function() {
  var birthDatePropTag, birthDateTag, birthYearTag, isPersonTag, models, rdfSyntaxTag, resourceURL, _findBirthDate, _validateBirth, _validatePerson;
  ...
  exports.parse = function(data, wikipage) {
    var birthDate, newPerson, results;
    try {
