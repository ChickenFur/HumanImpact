define [], () ->
  -> 
    ...
    body = d3.select('body')
    svg = body.append('svg')
    ocean_fill = svg.append("defs").append("radialGradient")
      .attr("id", "ocean_fill")
      .attr("cx", "75%")
      .attr("cy", "25%");
    ...
    def = svg.append("defs")
    globe_highlight = def.append("radialGradient")
    ...
    globe_shading = def.append("radialGradient")
    ...
    grad = def.append('linearGradient')
      .attr
        id:'brush'
        x1:'0%'
        x2:'0%'
